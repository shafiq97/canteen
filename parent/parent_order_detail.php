                ...
                <div class="col mb-2 mb-md-0">
                    <ul class="list-unstyled fw-light">
                        ...
                        <li class="list-item">From
                            <a class="text-decoration-none link-primary" href="admin_shop_detail.php?c_id=<?php echo $orh_arr['s_id'] ?>">
                                <?php
                        ...
                        <li class="list-item">Order of
                            <a class="text-decoration-none link-primary" href="parent_customer_detail.php?c_id=<?php echo $orh_arr['c_id'] ?>">
                                <?php
                ...
                <div class="row row-cols-1">
                    ...
                    <div class="col row row-cols-1 row-cols-md-2 border-bottom">
                        ...
                        ?>
                            <div class="col">
                                <ul class="list-group">
                                    <a class="text-decoration-none" href="admin_food_detail.php?f_id=<?php echo $ord_row["f_id"] ?>">
                                        <li class="list-group-item d-flex border-0 pb-3 border-bottom w-100 justify-content-between align-items-center">
                                            <div class="image-parent">
                                                <img <?php
                                                        if (is_null($ord_row["f_pic"])) {
                                                            echo "src='../img/default.png'";
                                                        } else {
                                                            echo "src=\"../img/{$ord_row['f_pic']}\"";
                                                        }
                                                        ?> class="img-fluid rounded" style="width: 100px; height:100px; object-fit:cover;" alt="<?php echo $ord_row["f_name"] ?>">
                                            </div>
                                            <div class="ms-3 me-auto">
                                                <div class="fw-normal"><span class="h5"><?php echo $ord_row["ord_amount"] ?>x
                                                    </span><?php echo $ord_row["f_name"] ?>
                                                    <p><?php printf("%.2f MYR <small class='text-muted'>(%.2f MYR each)</small>", $ord_row["ord_buyprice"] * $ord_row["ord_amount"], $ord_row["ord_buyprice"]); ?><br />
