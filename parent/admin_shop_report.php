        ...
        <div class="container row row-cols-6 row-cols-md-12 g-5 pt-4 mb-4" id="shop-header">
            ...
            <div class="col-6 col-md-8">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="">Telephone number: <?php echo "(+60) ".$shop_row["s_phoneno"];?></li>
                </ul>
                ...
                <div class="col">
                    <div class="card border-secondary">
                        <div class="card-body">
                            <h5 class="card-title">
                                <?php
                                    if($num_order == 0){echo "0.00 MYR";}
                                    else{printf("%.2f MYR",$grandtotal/$num_order);}
                                ?>
                            </h5>
                ...
                <table class="table rounded-5 table-light table-striped table-hover align-middle caption-top mb-5">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $row["f_price"]." MYR"?></td>
                            <td><?php echo $row["amount"]." plates"?></td>
                            <td><?php echo $row["subtotal"]." MYR"?></td>
                        </tr>
                        <?php } ?>
                        <tr class="fw-bold table-info">
                            <td colspan="4" class="text-end">Grand Total</td>
                            <td><?php printf("%.2f MYR",$grandtotal);?></td>
                        </tr>
                    </tbody>
                </table>
                <?php }else{ ?>
