                                ...
                                ?>
                                    <li class="list-group-item d-flex border-0 pb-3 border-bottom w-100 justify-content-between align-items-center">
                                        <div class="image-parent">
                                            <img <?php
                                                    if (is_null($row["f_pic"])) {
                                                        echo "src='img/default.png'";
                                                    } else {
                                                        echo "src=\"img/{$row['f_pic']}\"";
                                                    }
                                                    ?> class="img-fluid rounded" style="width: 100px; height:100px; object-fit:cover;" alt="quixote">
                                        </div>
                                        <div class="ms-3 mt-3 me-auto">
                                            <div class="fw-normal"><span class="h5"><?php echo $row["ct_amount"] ?>x</span>
                                                <?php echo $row["f_name"] ?>
                                                <p><?php printf("%.2f MYR <small class='text-muted'>(%.2f MYR each)</small>", $row["f_price"] * $row["ct_amount"], $row["f_price"]) ?><br />
                                                ...
                                                <ul class="list-unstyled list-inline">
                                                    <li>
                                                        ...
                                                        ?>
                                                            ...
                                                            <?php } else if ($row["f_todayavail"] == 0) { ?>
                                                ...
                                                <?php if ($rmv_link) { ?>
                                                    <a href="remove_cart_item.php?rmv=1&s_id=<?php echo $cart_result["s_id"]; ?>&f_id=<?php echo $row["f_id"]; ?>" class="text-decoration-none text-danger nav nav-item small">Remove item</a>
                                                <?php } else { ?>
                                                    <a href="cust_update_cart.php?s_id=<?php echo $cart_result["s_id"]; ?>&f_id=<?php echo $row["f_id"]; ?>" class="text-decoration-none text-success nav nav-item small">Edit item</a>
                                                <?php } ?>
                                            </div>
                                    </li>
                                    <!-- END CART ITEM -->
                            ...
                            <div class="col my-3">
                                <ul class="list-inline justify-content-between">
                                    <li class="list-item mb-2">
                                        <a href="remove_cart_all.php?rmv=1&s_id=<?php echo $cart_result["s_id"]; ?>" class="nav nav-item text-danger text-decoration-none small" name="rmv_all" id="rmv_all">
                        ...
                        <form method="POST" action="add_order.php" id="paymentForm">
                            <div class="col mb-1">
                                <div class="card px-2 px-md-4 pb-1 pb-md-2 border-0">
                                    ...
                                    <input type="datetime-local" class="form-control" name="pickuptime" id="pickuptime" min="<?php echo $min_datetime ?>" max="<?php echo $max_datetime ?>" value="<?php echo $min_datetime ?>" <?php if ($no_order) {
                                                                                                                                                                                                                                    echo "disabled";
                                                                                                                                                                                                                                } ?>>
