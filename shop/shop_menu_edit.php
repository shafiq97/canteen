...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin mt-auto w-50">
        ...
        <form method="POST" action="shop_menu_edit.php" class="form-floating" enctype="multipart/form-data">
            ...
            <div class="form-floating mb-2">
                <input type="number" step=".25" min="0.00" max="999.75" class="form-control" id="f_price" placeholder="Price (MYR)" value="<?php echo $row["f_price"];?>" name="f_price" required>
                <label for="f_price">Price (MYR)</label>
            </div>
            <div class="mb-2">
